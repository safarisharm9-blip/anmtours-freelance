  ...
  return (
    <main style={{minHeight:'85vh',display:'flex',alignItems:'center',justifyContent:'center',padding:'24px'}}>
      <div style={{textAlign:'center',maxWidth:'600px'}}>
        ...
        <p style={{fontSize:'18px',color:'#333'}}>Your boat trip booking in Sharm El Sheikh has been received successfully.</p>
        <p style={{fontSize:'18px',color:'#555'}}>Our team will contact you on WhatsApp within 10 minutes.</p>
